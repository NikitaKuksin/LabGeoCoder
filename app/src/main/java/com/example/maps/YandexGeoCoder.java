...
public class YandexGeoCoder {
    ...
    public interface Callback {
        void onAddressSuccessfully(ArrayList<GeoPoint> points);
        void onErrorAddress(String string);
    }
        ...
        new AsyncNetworking() {
            ...
            protected void onPostExecute(String result) {
                try {
                    ...
                    cb.onAddressSuccessfully(points);

                } catch (Exception e) {
                    cb.onErrorAddress("Адресс не найден");
                }
            }
